...
def get_config():
    ...
    parser.add_argument("--cuda", dest="cuda", action="store_true", default=True,
                        help="use CUDA for the policy when available (default: enabled)")
    parser.add_argument("--no_cuda", dest="cuda", action="store_false",
                        help="force policy training onto CPU")
    ...
    # Symmetry-reduced communication. These options are used only by sr_mappo.
    parser.add_argument("--sr_comm_rounds", type=int, default=2)
    parser.add_argument("--sr_hidden_dim", type=int, default=96)
    parser.add_argument("--sr_latent_dim", type=int, default=32)
    parser.add_argument("--sr_num_codebooks", type=int, default=4)
    parser.add_argument("--sr_codebook_size", type=int, default=16)
    parser.add_argument("--sr_reconstruction_coef", type=float, default=0.1)
    parser.add_argument("--sr_vq_coef", type=float, default=0.1)
